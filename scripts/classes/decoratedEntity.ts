...
export class decoratedEntity extends compactEntity {
    ...
    public damageDealt: Array<any> = [];
    public damageTypes: Array<any> = [];
    public matchedPacks: Array<string> = [];
    public matchedPacksString: string = '';
    ...
    */
    public static decorate(
        entity: any,
        entityType: string,
        packList: { [key: string]: any } | null = null,
        classList: { [key: string]: any } | null = null,
        subClasses: { [key: string]: any } | null = null
    ): decoratedEntity {
        let decorated = new decoratedEntity(),
        ...
        switch (entityType) {
            ...
            case 'Actor':
                ...
                let challengeRating = () => {
                    let cr: number | string = Number(entityData.data.details.cr) || 0;
                ...
                switch (entityData.data.traits.size) {
                    case 'grg': decorated.filterSize = 5; break;
                    case 'huge': decorated.filterSize = 4; break;
                    case 'lg': decorated.filterSize = 3; break;
                    case 'sm': decorated.filterSize = 1; break;
                    case 'tiny': decorated.filterSize = 0; break;
                    case 'med':
                    default: decorated.filterSize = 2; break;
                }
