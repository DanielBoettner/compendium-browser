 ...
 */
 class tableHelper {
	 ...
	 * accessing it. 
	 * 
	 * @param {String<String>} rolltableReference 
	 * @returns {RollTable}
	 * 
	 * @version 1.0.0
	 */
	static async _getRolltable(rolltableReference: String): Promise<RollTable> {
	 ...
	 * @returns {Document}
	 */
    static async _rollSubTables(item: Item, index = 0) {
